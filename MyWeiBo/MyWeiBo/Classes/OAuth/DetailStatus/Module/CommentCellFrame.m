...
-(void)setComment:(Comment *)comment{
    ...
    // 时间
    CGSize timeSize = [comment.createAt sizeWithFont:kTimeFont];
    ...
    CGSize textSize = [comment.text sizeWithFont:kTextFont constrainedToSize:CGSizeMake(cellWidth - 2 * kCellPaddingWidth, MAXFLOAT)];
